			  ...
			  if ((XNetRXBuffer.msg[XNetRXBuffer.get].data[XNetdata1] == 0x01) && (XNetRXBuffer.msg[XNetRXBuffer.get].data[XNetdata2] == 0x60)) {
				...
				for (byte i = 1; i <= len; i++) {
					if(notifyXNetFeedback)
						//notifyXNetFeedback((XNetRXBuffer.msg[XNetRXBuffer.get].data[XNetheader+(i*2)-1]) << 8 | (XNetRXBuffer.msg[XNetRXBuffer.get].data[XNetheader+(i*2)] ), XNetRXBuffer.msg[XNetRXBuffer.get].data[XNetheader+(i*2)]);
